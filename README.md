...
│
├── docs/
│   ├── axi4_lite_terminal_pass.png
│   └── axi4_lite_waveform.png
│
└── README.md
```
...
![Terminal Output](docs/axi4_lite_terminal_pass.png)

### Waveform

![Waveform](docs/axi4_lite_waveform.png)
